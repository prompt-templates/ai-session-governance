...
2026-04-26（v3.0.2）時点の要約：
- AGENTS/INIT 規則整合：検証済み（255 項自動回帰 — 166 メイン + 89 legacy 自動チェーン）
- AGENTS.md L4 削減：734 → 504 行（−31.3%）、すべてのルールと 218 個の grep アンカーを完全保持（212 baseline + R29×12 release-doc sync + R30×6 release-lifecycle 4-phase enforcement）
