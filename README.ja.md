...
**[30秒クイックスタート](#quickstart)** · **[インストール / アップグレード](#install)** · **[クイック操作](#quick-operations)**
...
インストール済みの場合は最新版 `INIT.md` を再実行します — 初回インストールと同じフローです。
...
インストール済みバージョンを問わず利用可能。ガバナンスセクションが最新化され、標準セクション外に追加したコンテンツは保持されます。
