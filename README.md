...
# :rocket: Stop repeating yourself to your AI — every single session
...
## :bookmark_tabs: Why this matters
...
### :small_blue_diamond: Pain point 1 — Every new session starts from scratch
...
### :small_blue_diamond: Pain point 2 — Fixes keep getting layered on top of old fixes
...
### :small_blue_diamond: Pain point 3 — Bugs get fixed locally, but governance gets worse globally
...
### :small_blue_diamond: What this template gives back

#### :small_orange_diamond: 1) Continuity
Every new session has a mandatory entry path:
- read the handoff
- read the log
- continue from the latest verified state

#### :small_orange_diamond: 2) Control
...
#### :small_orange_diamond: 3) Anti-chaos guardrails
...
### :small_blue_diamond: 2) Continue active work in the same session

```text
Continue from the current state and proceed with PLAN → READ → CHANGE → QC → PERSIST.
```

### :small_blue_diamond: 3) Close the session with full handoff
...
### :small_blue_diamond: 4) Start the next session quickly
...
## :bookmark_tabs: What makes this template different
...
### :small_blue_diamond: 1) Session continuity
The next session should not depend on user memory.

### :small_blue_diamond: 2) Layer separation
...
### :small_blue_diamond: 3) Read before change
No "see one fragment, patch one fragment" workflow.

### :small_blue_diamond: 4) Consolidate before adding
No endless stacking of new rules and exceptions.

### :small_blue_diamond: 5) Close the session properly
...
### :small_blue_diamond: Scenario 1 — Solo founder shipping with AI every day
...
### :small_blue_diamond: Scenario 3 — Existing project already feels messy
...
### :small_blue_diamond: 3) Is this a coding standard?
Not primarily.
...
### :small_blue_diamond: 4) Why not just keep everything inside one giant prompt?
...
### :small_blue_diamond: 5) Will this slow the agent down?
...
### :small_blue_diamond: 6) What problem does "consolidation before adding" solve?
...
### :small_blue_diamond: 7) When should a problem become a permanent rule?
...
### :small_blue_diamond: 8) Does this help with debugging, or only with documentation?
Both.
...
### :small_blue_diamond: 9) What if my project already has README, docs, and internal rules?
Keep them.
...
### :small_blue_diamond: 10) What is the biggest mistake this template is designed to prevent?
The quiet one:
...
## :bookmark_tabs: Governance principles behind this template
...
## :bookmark_tabs: Verification record
...
### :small_blue_diamond: Claim-to-mechanism mapping
...
### :small_blue_diamond: Platform compatibility verified
...
### :small_blue_diamond: What was not verified
