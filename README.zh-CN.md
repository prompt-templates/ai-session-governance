...
| 版本 | 变更内容 | 对你的意义 |
|---|---|---|
| **v2.4** | AI 现在会在 PLAN 阶段主动质疑自己的假设；工作日志改用精简格式（每条记录缩小约 60%）；归档门槛从 800 行降至 400 行（目标 ≤ 200），基于 "lost in the middle" 研究显示中段内容准确率下降 30%+ | 计划质量更高、AI 启动更快、相同空间容纳更多历史 |
...
截至 2026-04-08 的摘要如下：
- AGENTS/INIT 规则同步：已验证（163 项回归测试）
- 多平台指针文件行为：已验证
- 50+ 工作阶段的长期纵向效果：尚未验证
