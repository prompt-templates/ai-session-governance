...
## FILE 7: docs/qa/session_log_maintenance.py
Rule if exists: replace (template-managed utility; preserve local custom forks in a separate file if needed).
...
- Which were replaced (docs/qa/session_log_maintenance.py if it existed)
